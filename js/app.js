(() => {
    ...
    function initSliders() {
        if (document.querySelector(".why__slider")) new swiper_core_Swiper(".why__slider", {
            ...
            navigation: {
                prevEl: ".why__navigation .swiper-button-prev",
                nextEl: ".why__navigation .swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".marketing__slider")) new swiper_core_Swiper(".marketing__slider", {
        ...
        if (document.querySelector(".project__slider") && window.innerWidth < 991.98) new swiper_core_Swiper(".project__slider", {
        ...
        if (document.querySelector(".sales__slider")) new swiper_core_Swiper(".sales__slider", {
            modules: [ Navigation, EffectFade, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".sales__navigation .swiper-button-prev",
                nextEl: ".sales__navigation .swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".manage__slider") && window.innerWidth < 1250) new swiper_core_Swiper(".manage__slider", {
            modules: [ Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        if (isMobile.any()) for (let card of cards) {
            let item = card.parentNode;
            item.addEventListener("click", documentActions);
            function documentActions() {
                if (!item.classList.contains("_open")) {
                    if (document.querySelector("._open")) document.querySelector("._open").classList.remove("_open");
                    item.classList.add("_open");
                } else item.classList.remove("_open");
            }
        }
        if (document.querySelector(".hero__images")) {
            document.querySelector(".menu__button").addEventListener("mouseover", (() => {
                document.querySelector(".hero__images").classList.add("_hover");
            }));
            document.querySelector(".menu__button").addEventListener("mouseout", (() => {
                document.querySelector(".hero__images").classList.remove("_hover");
            }));
            document.querySelector(".hero__button").addEventListener("mouseover", (() => {
                document.querySelector(".hero__images").classList.add("_hover");
            }));
            document.querySelector(".hero__button").addEventListener("mouseout", (() => {
                document.querySelector(".hero__images").classList.remove("_hover");
            }));
        }
    };
